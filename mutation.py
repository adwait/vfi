# mutation.py
# 
# Verilog mutation testing script.
# 
# This script is borrowed and adapted from smartVerilog (https://github.com/lichye/smartVerilog/)
# by Leiqi Ye, Univ. of Edinburgh
